...
{ 
    ...
    Task<ResponseDto> GetAllDocumentsMobile(Guid? workFlowId, Guid documentTypeId,bool isArchive, Guid userId);
    Task<ResponseDto> GetDocumentDetailById(Guid documentId, Guid userId,bool isArchive);
