...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250530110550_UpdateDataBaseVersion5_6_Add_Scope_Flow")]
    partial class UpdateDataBaseVersion5_6_Add_Scope_Flow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.ArchivedDocument", b =>
                {
                    ...
                    b.Property<string>("SystemNumberOfDoc")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BusinessObject.Tasks", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.UserDocumentPermission", b =>
                {
                    ...
                    b.Property<int>("GrantPermission")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BusinessObject.ArchivedDocument", b =>
                {
                    b.HasOne("BusinessObject.ArchivedDocument", "DocumentReplaces")
                        .WithOne()
                        .HasForeignKey("BusinessObject.ArchivedDocument", "DocumentReplaceId");

                    b.HasOne("BusinessObject.ArchivedDocument", "DocumentRevokes")
                        .WithOne()
                        .HasForeignKey("BusinessObject.ArchivedDocument", "DocumentRevokeId");
            ...
            modelBuilder.Entity("BusinessObject.Comment", b =>
                {
                    b.HasOne("BusinessObject.DocumentVersion", "DocumentVersion")
                        .WithMany("Comments")
